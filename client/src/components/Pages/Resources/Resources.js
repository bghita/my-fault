...
function App() {
  return (
    <div>
      ...
      <Row>
        {/* hotel search */}
        <ResourceCard imgUrl="https://media.giphy.com/media/NDEVHw57wMU5a/giphy.gif" href="http://www.femaevachotels.com/index.php" title="Find Hotel" description="Search for hotels in your state and city. Locates hotels that are pet friendly. Posts rates for the night." />

        {/* Phone Directory */}
        <ResourceCard imgUrl="http://picsum.photos/200/200" href="" title="Phone Directory" description="911 Emergency Service. #411 Information Sevrvice. 1-800-743-5000 PG & E gas leak." />
      ...
      <Row>
        {/* family preparedness */}
        <ResourceCard imgUrl="https://media.giphy.com/media/l3vR9Q7dANqZyK2sw/giphy.gif" href="https://www.earthquakeauthority.com/California-Earthquake-Risk/Personal-Preparedness" title="FAQ" description="Information on earthquake prep. Be prepared before a disaster. Read 7 helpfiul tips." />
